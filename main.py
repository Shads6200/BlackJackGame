...
import art 
import random
play = input("Want to play a game of blackjack? Type 'y' or 'n': ")
def
while play == "y":
  print(art.logo)
  cards = [random.randint(1,10),random.randint(2,11)]
  current_score = sum(cards)
  computer_first_card = random.randint(1,10)
  computer_cards= [computer_first_card, random.randint(2,11)]
